    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center py-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">🪙 Ma Cagnotte Digitale</h1>
          <p className="text-gray-600">Économise pour tes projets !</p>
        </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg">
              ...
              Objectif : {goalName}
              {!isEditingGoal && (
                <Button variant="ghost" size="sm" onClick={startEditingGoal} className="ml-auto p-1 h-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-medium">Paliers</h4>
              ...
              <>
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-600">
                    {achievedMilestones}/{milestones.length} paliers atteints
                  </p>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs text-gray-500">Total: {cumulativePrice.toFixed(2)}€</div>
                        </div>
                      </div>
                    )
                  })}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    Reste {Math.max(0, totalGoal - balance).toFixed(2)} € à économiser
                  </p>
                </div>
              </>
            )}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Ajouter de l'argent</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <footer className="text-center text-sm mt-8 text-gray-600">
        ...
        <p>
          Projet conçu par <strong className="text-yellow-600">Code no Senpaï</strong> —{" "}
          <em>coder comme un ninja, enseigner comme un sensei.</em>
        </p>
      </footer>
